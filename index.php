...
$countries = $conn->query("SELECT countries.id AS id, countries.name AS name, countries.images AS image, 
countries.population AS population, countries.continent AS continent, countries.territory AS territory, countries.description AS description,
 AVG(cities.price) AS avg_price, cities.image AS city_image FROM countries JOIN cities ON countries.id = cities.country_id GROUP BY (cities.country_id)");
      ...
      <div id="top-banner-<?= $country->id; ?>" class="banner">
        <div class="banner-inner-wrapper header-text">
          <div class="main-caption">
            ...
            <h1><?= $country->name; ?></h1>
            <div class="border-button"><a href="about.php?id=<?= $country->id; ?>">Go There</a></div>
          </div>
          <div class="container">
            <div class="row">
              <div class="col-lg-12">
                <div class="more-info">
                  <div class="row">
                    ...
                    <div class="col-lg-3 col-sm-6 col-6">
                      ...
                      <h4><span>AVG Price:</span><br>$<?= $country->avg_price; ?>.000</h4>
                    </div>
                    <div class="col-lg-3 col-sm-6 col-6">
